...
// WE'RE GOING TO NEED TO FEED TEXT that we get from our joke API and we want audio in return , we can use text to speech API
...
// function test(){
    // VoiceRSS.speech({
    //     key: '64cfa0a93c134aabb392c5cd07af85d3',
    //     src: 'Hello, I am alexa . How I can help you. I would be happy to help you. I am always there for you no matter what',
    //     hl: 'en-us',
    //     v: 'Linda',
    //     r: 0, 
    //     c: 'mp3',
...
async function getJokes(){
    ...
    try{
        ...
        // console.log(data);
        if (data.setup){
            // backticks - for template strings because it's easier to add strings and variable together into one string 
...
// we want to not be able to press the button again until our joke is done being told 
// button can be disabled as the audio is playing and enabled when audio ends
// disable the button as the audio is playing and enable it again - dynamic approach 